...
const BUILDING_DEFS = {
  ...
  fishery: {
    ...
    cost: { wood: 20 }, buildMs: 6000, produces: { resource: "food", rate: 0.65 }, requiresWorker: true,
    icon: Anchor, desc: "Fishes the shallows. Must connect to your territory. +0.65 food/sec.",
  },
